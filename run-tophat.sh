...
tophat2 --b2-very-sensitive -o $fastq-tophat-out -p 12 -r 50 --mate-std-dev 100 -G /scratch/at120/shared/db/organism/brugia/b_malayi.PRJNA10729.WS252.annotations.gff3 /scratch/at120/shared/db/organism/brugia/b_malayi.PRJNA10729.WS252.genomic_masked.fa $fastq.r1.fastq $fastq.r2.fastq
